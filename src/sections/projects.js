...
/**
 * Projects section — horizontal scroll gallery on desktop.
 */
export function initProjects() {
  ...
  const cards = CONFIG.projects.map((p, i) => `
    <article class="project-card" style="--card-accent:${p.accent}" aria-label="${p.title}">
      <div class="card-inner">
        ...
        ${p.github ? `
          <a href="${p.github}" class="card-link" target="_blank" rel="noopener noreferrer" aria-label="View ${p.title} on GitHub">
  ...
  section.innerHTML = `
    <div class="projects-header container">
      ...
      <p class="projects-hint" aria-hidden="true">Scroll to explore →</p>
    </div>
